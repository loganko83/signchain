...
}`,language:"javascript",id:"webhook-verify"})]})]})]})}),e.jsx(h,{value:"examples",className:"space-y-6",children:e.jsxs(d,{children:[e.jsxs(n,{children:[e.jsx(o,{children:"코드 예제"}),e.jsx(c,{children:"다양한 언어로 작성된 SignChain API 사용 예제"})]}),e.jsxs(l,{className:"space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"font-semibold mb-3",children:"JavaScript (Node.js)"}),e.jsx(a,{code:`const axios = require('axios');
...
}`,language:"typescript",id:"sdk-example"})]}),e.jsx(i,{}),e.jsxs("div",{children:[e.jsx("h3",{className:"font-semibold mb-3",children:"추가 리소스"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs(p,{variant:"outline",className:"w-full justify-start",children:[e.jsx(x,{className:"h-4 w-4 mr-2"}),"GitHub 리포지토리"]}),e.jsxs(p,{variant:"outline",className:"w-full justify-start",children:[e.jsx(x,{className:"h-4 w-4 mr-2"}),"NPM 패키지"]}),e.jsxs(p,{variant:"outline",className:"w-full justify-start",children:[e.jsx(x,{className:"h-4 w-4 mr-2"}),"API 테스트 도구"]})]})]})]})]})})]})]})})}export{$ as default};
